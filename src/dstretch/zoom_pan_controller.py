...
class CoordinateTransformer:
    ...
    def canvas_to_image(self, canvas_x: int, canvas_y: int) -> Tuple[Optional[int], Optional[int]]:
...
class ImageRenderer:
    ...
    def render_image(self, pil_image: Image.Image, view_state: ViewState) -> Tuple[ImageTk.PhotoImage, int, int]:
        ...
        if (target_width > view_state.canvas_width or target_height > view_state.canvas_height):
...
class ZoomPanController:
    ...
    def __init__(self, canvas: tk.Canvas, update_callback: Optional[Callable] = None):
        self.canvas = canvas
    ...
    def get_image_coordinates(self, canvas_x: int, canvas_y: int) -> Tuple[Optional[int], Optional[int]]:
