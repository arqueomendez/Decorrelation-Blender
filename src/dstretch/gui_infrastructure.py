...
class ErrorManager:
    ...
    def handle_error(self, error: Exception, context: str = "", 
                    user_message: str = None, show_dialog: bool = True) -> bool:
...
class AdvancedStatusBar:
    ...
    def __init__(self, parent):
        ...
        self.main_label.grid(row=0, column=0, sticky=(tk.W, tk.E), padx=(0, 2))
    ...
    def set_image_info(self, width: int = None, height: int = None, filename: str = None):
    ...
    def set_processing_info(self, colorspace: str = None, scale: float = None):
...
class PerformanceManager:
    ...
    def execute_with_progress(self, func: Callable, status_bar: AdvancedStatusBar,
                            total_steps: int = 100, step_callback: Callable = None):
...
class GUIInfrastructure:
    ...
    def execute_async(self, func: Callable, success_callback: Callable = None,
                     error_callback: Callable = None, *args, **kwargs):
        """Execute function asynchronously."""
        return self.thread_manager.execute_async(
            func, success_callback, error_callback, *args, **kwargs
        )
